					...
					<div class="uslugi_zapic_block col-12 ">
						<div class="col-12">
							...
							<div class="uslugi_language_block_left">
								<p class="uslugi_language_block_span"><span>Курсы немецкого для детей</span></p>
								<p class="">c 7 лет</p>
							</div>
						</div>
						<div class="col-12 uslugi_language_block_p">
							<p>Мы не просто учим детей правилам грамматики и новым немецким словам, но и показываем им на практике выгоды от изучения немецкого языка.
Классические занятия проходят два раза в неделю, а по выходным мы проводим занятия клуба на немецком языке - игры, кино, творческие занятия и мастер-классы.</p>
						</div>
