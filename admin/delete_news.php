		...
		<section class="container-fluid container">
			<div class="row">
				...
				<div class="admin_block col-8">
					<form method="POST" action="drop_news.php">
					<?php 
			
					$result = mysqli_query($db,"SELECT title,id FROM `news`");
					...
					while($myrow = mysqli_fetch_assoc($result));
			 		...
			 		?>
			 			<input class="col-3 admin_btn" type="submit" name="submit" value="Удалить новость">
			 		</form>
				</div>
			</div>
		</section>
