		...
		<section class="container-fluid container">
			<div class="row">
				...
				<div class="admin_block col-8">
					<?php
						if (isset($title) && isset($language) && isset($cost) && isset($description_short) && isset($description_long) && isset($link) && isset($link_log)){
							//$FILES
							...
							if(!move_uploaded_file($_FILES['image']['tmp_name'], '../' . $path)){
								...
								$kek = "$path$image";
							$result = mysqli_query($db, "UPDATE courses SET title='$title', language='$language', cost='$cost', description_short='$description_short', description_long='$description_long', link='$link', link_log='$link_log', image='$kek' WHERE id='$id'"); 
							if($result == 'true'){
								echo "<p>Ваш курс успешно обновлен!</p>";
							}else{
								echo "<p>Ваш курс не обновлен!</p>";
							}
						}else{
