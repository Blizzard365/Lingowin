		...
		<section class="container-fluid container">
			<div class="row">
				...
				<div class="admin_block col-8">
					<?php
						if (isset($id)){
							$result = mysqli_query($db, "DELETE FROM teachers WHERE id='$id'"); 
							if($result == 'true'){
								echo "<p>Ваш преподаватель успешно удалён!</p>";
							}else{
								echo "<p>Ваш преподаватель не удалён!</p>";
							}
						}else{
							echo "<p>Вы запустили данный файл без параметра id и поэтому, удалить урок не возможно.</p>";
						}
					?>
				</div>
			</div>
