			...
			<div class="row">
				...
				<div class="admin_block col-8">
					...
					while($myrow = mysqli_fetch_assoc($result));
			 		...
			 		?>
			 			<input class="col-3 admin_btn" type="submit" name="submit" value="Удалить курс">
			 		</form>
				</div>
			</div>
		</section>
