...
$result = mysqli_query($db, "SELECT title FROM `languages` WHERE id='3'");
...
<body>
	...
	<main>
		...
		<?php 
			$result = mysqli_query($db, "SELECT id, title, cost, description_short, description_long, link, link_log, image FROM `courses` WHERE language='Немецкий язык'");
